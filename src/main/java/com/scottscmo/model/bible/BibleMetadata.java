...
public class BibleMetadata {
    private static final Map<String, BookMetadata> bookInfoMap = Map.ofEntries(
        entry("genesis", new BookMetadata(
        ...
        entry("jeremiah", new BookMetadata(
        ...
        entry("lamentations", new BookMetadata(
            new int[]{22,22,66,22,22},
            24)
        ),
        entry("ezekiel", new BookMetadata(
        ...
        entry("daniel", new BookMetadata(
            new int[]{21,49,30,37,31,28,28,27,27,21,45,13},
            26)
        ),
        entry("hosea", new BookMetadata(
            new int[]{11,23,5,19,15,11,16,14,17,15,12,14,16,9},
            27)
        ),
        entry("joel", new BookMetadata(
            new int[]{20,32,21},
            28)
        ),
        entry("amos", new BookMetadata(
            new int[]{15,16,15,13,27,14,17,14,15},
            29)
        ),
        entry("obadiah", new BookMetadata(
            new int[]{21},
            30)
        ),
        entry("jonah", new BookMetadata(
            new int[]{17,10,10,11},
            31)
        ),
        entry("micah", new BookMetadata(
            new int[]{16,13,12,13,15,16,20},
            32)
        ),
        entry("nahum", new BookMetadata(
            new int[]{15,13,19},
            33)
        ),
        entry("habakkuk", new BookMetadata(
            new int[]{17,20,19},
            34)
        ),
        entry("zephaniah", new BookMetadata(
            new int[]{18,15,20},
            35)
        ),
        entry("haggai", new BookMetadata(
            new int[]{15,23},
            36)
        ),
        entry("zechariah", new BookMetadata(
            new int[]{21,13,10,14,11,15,14,23,17,12,17,14,9,21},
            37)
        ),
        entry("malachi", new BookMetadata(
            new int[]{14,17,18,6},
            38)
        ),
        entry("matthew", new BookMetadata(
            new int[]{25,23,17,25,48,34,29,34,38,42,30,50,58,36,39,28,27,35,30,34,46,46,39,51,46,75,66,20},
            39)
        ),
        entry("mark", new BookMetadata(
            new int[]{45,28,35,41,43,56,37,38,50,52,33,44,37,72,47,20},
            40)
        ),
        entry("luke", new BookMetadata(
            new int[]{80,52,38,44,39,49,50,56,62,42,54,59,35,35,32,31,37,43,48,47,38,71,56,53},
            41)
        ),
        entry("john", new BookMetadata(
            new int[]{51,25,36,54,47,71,52,59,41,42,57,50,38,31,27,33,26,40,42,31,25},
            42)
        ),
        entry("acts", new BookMetadata(
            new int[]{26,47,26,37,42,15,60,40,43,48,30,25,52,28,41,40,34,28,41,38,40,30,35,27,27,32,44,31},
            43)
        ),
        entry("romans", new BookMetadata(
            new int[]{32,29,31,25,21,23,25,39,33,21,36,21,14,23,33,27},
            44)
        ),
        entry("1 corinthians", new BookMetadata(
            new int[]{31,16,23,21,13,20,40,13,27,33,34,31,13,40,58,24},
            45)
        ),
        entry("2 corinthians", new BookMetadata(
            new int[]{24,17,18,18,21,18,16,24,15,18,33,21,14},
            46)
        ),
        entry("galatians", new BookMetadata(
            new int[]{24,21,29,31,26,18},
            47)
        ),
        entry("ephesians", new BookMetadata(
            new int[]{23,22,21,32,33,24},
            48)
        ),
        entry("philippians", new BookMetadata(
            new int[]{30,30,21,23},
            49)
        ),
        entry("colossians", new BookMetadata(
            new int[]{29,23,25,18},
            50)
        ),
        entry("1 thessalonians", new BookMetadata(
            new int[]{10,20,13,18,28},
            51)
        ),
        entry("2 thessalonians", new BookMetadata(
            new int[]{12,17,18},
            52)
        ),
        entry("1 timothy", new BookMetadata(
            new int[]{20,15,16,16,25,21},
            53)
        ),
        entry("2 timothy", new BookMetadata(
            new int[]{18,26,17,22},
            54)
        ),
        entry("titus", new BookMetadata(
            new int[]{16,15,15},
            55)
        ),
        entry("philemon", new BookMetadata(
            new int[]{25},
            56)
        ),
        entry("hebrews", new BookMetadata(
            new int[]{14,18,19,16,14,20,28,13,28,39,40,29,25},
            57)
        ),
        entry("james", new BookMetadata(
            new int[]{27,26,18,17,20},
            58)
        ),
        entry("1 peter", new BookMetadata(
            new int[]{25,25,22,19,14},
            59)
        ),
        entry("2 peter", new BookMetadata(
            new int[]{21,22,18},
            60)
        ),
        entry("1 john", new BookMetadata(
            new int[]{10,29,24,21,21},
            61)
        ),
        entry("2 john", new BookMetadata(
            new int[]{13},
            62)
        ),
        entry("3 john", new BookMetadata(
            new int[]{15},
            63)
        ),
        entry("jude", new BookMetadata(
            new int[]{25},
            64)
        ),
        entry("revelation", new BookMetadata(
